...
export const siteConfig = {
  ...
  shortTitle: "Ignición",
  description:
    "Juan Esteban Deossa Pertuz presenta una propuesta de alianza con Potencia E: beca de mutualidad para Ingeniería Física en EAFIT, con experiencia en software y un compromiso de devolver valor a la comunidad.",
  tagline: "Propuesta de alianza con Potencia E",
  author: "Juan Esteban Deossa Pertuz",
  locale: "es_CO",
  ogImage: "/og-image.jpg",
  ogImageAlt:
    "Ignición — propuesta de alianza de Juan Esteban Deossa Pertuz con Potencia E para Ingeniería Física en EAFIT",
  ogImageWidth: 1200,
  ogImageHeight: 630,
